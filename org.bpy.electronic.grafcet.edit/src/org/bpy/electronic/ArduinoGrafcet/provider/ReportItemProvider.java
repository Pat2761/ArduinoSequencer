...
/**
 * This is the item provider adapter for a {@link org.bpy.electronic.ArduinoGrafcet.Report} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReportItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Report_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Report_label_feature", "_UI_Report_type"),
				 GrafcetPackage.Literals.REPORT__LABEL,
				 true,
				 false,
				 false,
	...
	protected void addNextStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Report_nextStep_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Report_nextStep_feature", "_UI_Report_type"),
				 GrafcetPackage.Literals.REPORT__NEXT_STEP,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Report)object).getLabel();

...
/**
 * This is the item provider adapter for a {@link org.bpy.electronic.ArduinoGrafcet.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider extends GrafcetElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_actionFct_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_actionFct_feature", "_UI_Action_type"),
				 GrafcetPackage.Literals.ACTION__ACTION_FCT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Action)object).getComment();
